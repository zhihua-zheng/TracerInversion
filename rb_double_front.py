...
parser.add_argument('--spinup', help='run simulations in spinup mode',
                    action='store_true')
parser.add_argument('--tra_inv', help='run simulations with tracers for inversion',
                    action='store_true')
...
casenames = [# front
             ...
             "d22_M006_Ri020_em01_Q000_W000_D000_St0",
             "d22_M006_Ri020_em01_Q001_W000_D000_St0",
             "d22_M006_Ri020_em01_Q010_W000_D000_St0",
            ]
...
for casename in casenames:
    if args.spinup:
        ...
        pre_filename  = 'run_double_front_tracer.sh'
        pbs_pre  = main_script.format(casename, tracer_flag)#--nday 1
